    ...
    <style>
        * {
        ...
        .left-container { 
            ...
            width: 950px; /* Fixed width of the container */
        ...
        .out-of-stock {
            color: red; /* Style for out of stock */
        }
    </style>
</head>
<body>
                ...
                <tbody id="materialList">
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            $quantityDisplay = $row['quantity'] == 0 ? "<span class='out-of-stock'>Out of Stock</span>" : htmlspecialchars($row['quantity']);
                            echo "<tr>
                        ...
                        echo "<tr><td colspan='4'>No materials found.</td></tr>"; // Updated colspan to 4
                    }
                    $conn->close();
                    ?>
                </tbody>
